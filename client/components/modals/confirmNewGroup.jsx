...
function ConfirmNewGroup() {
  ...
  return (
    ...
    >
      <div
        aria-hidden
        className={`${!modal.newGroup && 'scale-0'} transition w-[460px] m-6 p-4 grid rounded-md bg-white dark:bg-spill-800`}
        onClick={(e) => {
          e.stopPropagation();
        }}
      >
        ...
        <div>
          ...
          { respond.message && (
            <p className={`mt-1 ${!respond.success && 'text-rose-600 dark:text-rose-400'}`}>
              {respond.message}
            </p>
          ) }
        </div>
              ...
              <div className="mt-4 py-2 rounded-md overflow-hidden bg-spill-100 dark:bg-spill-900">
                ...
                <div className="relative flex items-center">
                  ...
                  <button
                    ...
                    onClick={() => {
                      const preview = document.querySelector('#new-group #participants-preview');
                      preview.scrollTo({
                  ...
                  >
                    {
                      selectedParticipants.map((elem) => (
                        <div key={elem._id} className="flex-none pointer-events-none flex flex-col items-center">
                          <img
