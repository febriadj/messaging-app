  ...
  return (
    <div
      ...
      className={`
        ...
        transition duration-200 absolute w-full h-full z-10 grid grid-rows-[auto_auto_1fr] overflow-hidden
    ...
    >
      ...
      <button
        type="button"
        className={`
          ${(modal.newGroup || selectedParticipants.length <= 0) && 'scale-0 opacity-0 -z-10'}
